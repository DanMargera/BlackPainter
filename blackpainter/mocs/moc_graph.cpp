...
QT_MOC_LITERAL(1, 6, 16), // "mouseDoubleClick"
QT_MOC_LITERAL(2, 23, 0) // ""

    },
    "Graph\0mouseDoubleClick\0"
};
...
void Graph::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Graph::mouseDoubleClick)) {
                *result = 0;
            }
        }
    }
