...
QT_MOC_LITERAL(3, 19, 8), // "mousePos"
QT_MOC_LITERAL(4, 28, 5), // "point"
QT_MOC_LITERAL(5, 34, 6), // "zoomIn"
QT_MOC_LITERAL(6, 41, 6), // "factor"
QT_MOC_LITERAL(7, 48, 7), // "zoomOut"
QT_MOC_LITERAL(8, 56, 10) // "normalSize"

    },
    "GraphicsView\0done\0\0mousePos\0point\0"
    "zoomIn\0factor\0zoomOut\0normalSize"
};
...
void GraphicsView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->mousePos((*reinterpret_cast< QPoint(*)>(_a[1]))); break;
        case 2: _t->zoomIn((*reinterpret_cast< qreal(*)>(_a[1]))); break;
        case 3: _t->zoomOut((*reinterpret_cast< qreal(*)>(_a[1]))); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GraphicsView::done)) {
                *result = 0;
            }
        }
        {
            typedef void (GraphicsView::*_t)(QPoint );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GraphicsView::mousePos)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 0
void GraphicsView::done()
{
    QMetaObject::activate(this, &staticMetaObject, 0, Q_NULLPTR);
}

// SIGNAL 1
void GraphicsView::mousePos(QPoint _t1)
{
