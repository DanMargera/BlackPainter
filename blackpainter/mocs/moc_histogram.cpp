...
QT_MOC_LITERAL(1, 10, 16), // "mouseDoubleClick"
QT_MOC_LITERAL(2, 27, 0) // ""

    },
    "Histogram\0mouseDoubleClick\0"
};
...
void Histogram::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Histogram::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Histogram::mouseDoubleClick)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void Histogram::mouseDoubleClick()
{
