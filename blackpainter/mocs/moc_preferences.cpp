...
QT_MOC_LITERAL(4, 26, 10), // "choosePath"
QT_MOC_LITERAL(5, 37, 9), // "applyPath"
QT_MOC_LITERAL(6, 47, 6), // "okPath"
QT_MOC_LITERAL(7, 54, 10), // "cancelPath"
QT_MOC_LITERAL(8, 65, 10) // "updateBtns"

    },
    "Preferences\0apply\0\0cancel\0choosePath\0"
    "applyPath\0okPath\0cancelPath\0updateBtns"
};
...
void Preferences::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->applyPath(); break;
        case 4: _t->okPath(); break;
        case 5: _t->cancelPath(); break;
        case 6: _t->updateBtns(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Preferences::apply)) {
                *result = 0;
            }
        }
        {
            typedef void (Preferences::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Preferences::cancel)) {
                *result = 1;
            }
        }
    }
